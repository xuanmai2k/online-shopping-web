                ...
                <form role="form" method="POST" action="{{ route('admin.product_category.update', ['id' => $productCategory[0]->id ]) }}">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ $productCategory[0]->name }}" name="name" class="form-control {{ $errors->any('name') ? 'is-invalid' : '' }}" id="name" placeholder="Name">
                    </div>
                    <div>
                        @error('name')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ $productCategory[0]->slug }}" name="slug" class="form-control {{ $errors->any('slug') ? 'is-invalid' : '' }}" id="slug" placeholder="Slug">
                    </div>
                    <div>
                        @error('slug')
                            <small style="color: red">{{ $message }}</small>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-select form-control {{ $errors->any('status') ? 'is-invalid' : '' }}" id="status">
